// lib/screens/add_delivery_challan_screen.dart (Example path)
...
class _AddDeliveryChallanScreenState extends State<AddDeliveryChallanScreen> {
  ...
  Future<void> _selectDate(BuildContext context, bool isChallanDate) async {
    ...
    if (picked != null && mounted) {
      setState(() {
        ...
        if (isChallanDate) {
          _challanDateController.text = formattedDate;
        } else {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('Add Delivery Challan'),
        centerTitle: true,
  ...
  Widget _buildAddProductsSection() {
    // Reusable from Add Invoice/Quotation
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
...
} // End _AddDeliveryChallanScreenState
