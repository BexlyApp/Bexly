// lib/screens/purchase_details_screen.dart (Example path)
...
class PurchaseDetailsScreen extends StatelessWidget {
  ...
  // --- Placeholder Data (Matches Invoice/Sales Return structure) ---
  final Map<String, dynamic> purchaseHeader = const {
    'title': 'Purchases Details',
    'status': 'Paid',
  };
  final Map<String, dynamic> purchaseInfo = const {
    'date': '15 Mar 2024',
    'po_no': 'QUO - 000015',
  };
  final Map<String, dynamic> purchaseAddresses = const {
    'to_name': 'Naveen Bansel',
    'to_details': 'yodha@gmail.com\n987654321',
    'pay_name': 'KanakkuLLC',
    'pay_details': 'Brooklyn, NY 333\nUSA',
  };
  final List<Map<String, dynamic>> purchaseItems = const [
    {
      'name': 'Nike Shoe',
      'unit': 'Pc',
      'qty': 10,
  ...
  final Map<String, dynamic> purchaseSummary = const {
    'amount': 11500.00,
    'discount': 1000.00,
    'tax': 500.00,
    'total': 11000.00,
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(purchaseHeader['title']),
        centerTitle: true,
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            _buildPurchaseHeader(purchaseHeader, statusColor),
            const SizedBox(height: 20),
            _buildDateAndPOSection(purchaseInfo),
            const SizedBox(height: 16),
            _buildAddressSection(purchaseAddresses),
            const SizedBox(height: 20),
            _buildSectionTitle('Items'),
            _buildItemsList(purchaseItems),
            ...
            const SizedBox(height: 20),
            _buildSectionTitle('Summary'), // Adjusted title
            _buildPurchaseSummary(purchaseSummary),
            const SizedBox(height: 20),
            _buildBottomButtons(),
            const SizedBox(height: 20),
          ],
  ...
  // --- Widget Builders (Reusing structure from Sales Return Details) ---

  Widget _buildPurchaseHeader(Map<String, dynamic> header, Color statusColor) {
    return Row(
  ...
  Widget _buildPurchaseSummary(Map<String, dynamic> summary) {
    return Container(
      padding: const EdgeInsets.all(16.0),
      decoration: BoxDecoration(
