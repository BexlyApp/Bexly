// lib/screens/add_purchase_return_screen.dart (Example path)
...
class _AddPurchaseReturnScreenState extends State<AddPurchaseReturnScreen> {
  ...
  final _purchaseReturnDateController = TextEditingController();
  final _dueDateController = TextEditingController();
  final _referenceController = TextEditingController();
  final _notesController = TextEditingController();
  final _termsController = TextEditingController();

  String? _selectedVendor; // Changed from Customer
  ...
  @override
  void dispose() {
    _purchaseReturnDateController.dispose();
  ...
  Future<void> _selectDate(
    ...
    if (picked != null && mounted) {
      setState(() {
        ...
        if (isPurchaseReturnDate) {
          _purchaseReturnDateController.text = formattedDate;
        } else {
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              // Changed label for the first date field
              _buildDateField(
                label: 'Purchases Date',
                controller: _purchaseReturnDateController,
                hint: 'Select Date',
                isRequired: true,
...
} // End _AddPurchaseReturnScreenState
