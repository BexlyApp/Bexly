...
class SubscriptionScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final plans = [
      ...
      _PlanData(
        tier: SubscriptionTier.go,
        title: 'Go',
        subtitle: 'Best for couples',
        monthlyPrice: notifier.getPrice(SubscriptionProducts.goMonthly) ?? '\$1.99',
        yearlyPrice: notifier.getPrice(SubscriptionProducts.goYearly) ?? '\$19.99',
        features: const [
          ...
          'Family sharing (2 members, Editor role)',
          'Ad-free',
        ],
        accentColor: AppColors.primary500,
        monthlyProductId: SubscriptionProducts.goMonthly,
