...
import 'package:bexly/core/components/scaffolds/custom_fab.dart';
        ...
        child: context.isDesktopLayout
            ...
            : Stack(
                children: [
                  ...
                  // Only show FAB when NOT on AI Chat screen (index 1)
                  if (currentPage != 1)
                    Positioned(
                      left: 0,
                      right: 0,
                      bottom: 60, // Position above bottom navigation
                      child: CustomFab(),
                    ),
                ],
              ),
