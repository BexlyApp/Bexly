...
class AppLocalizations {
  ...
  static const _localizedValues = <String, Map<String, String>>{
    'en': {
      ...
      // Pending transactions & bulk actions
      'allCaughtUp': 'All caught up!',
      'noPendingToReview': 'No pending transactions to review',
      'bulkActions': 'Bulk Actions',
      'acceptAll': 'Accept All',
      'rejectAll': 'Reject All',
      'acceptAllConfirm': 'Accept All?',
      'acceptAllDescription': 'This will import all pending transactions using their suggested categories. Transactions without a category will be skipped.',
      'rejectAllConfirm': 'Reject All?',
      'rejectAllDescription': 'This will reject all pending transactions. They won\'t reappear on future scans.',
      'transactionsImportedCount': '{count} transactions imported',
      'transactionsRejectedCount': '{count} transactions rejected',
      'transactionRejected': 'Transaction rejected',
      'pending': 'Pending',
      'pendingTransactions': 'Pending Transactions',
      'reviewAndImport': 'Review and import transactions',
      'approve': 'Approve',
      'reject': 'Reject',
      'reviewTransactions': 'Review Transactions',
      'approveAll': 'Approve All',
      'noTransactionsToReview': 'No transactions to review',
      'scanEmailsDesc': 'Scan your emails to find banking transactions',
      'goBack': 'Go Back',
      'pleaseSelectWallets': 'Please select wallets',
      'transactionsNeedWallet': '{count} transactions need a wallet selected',
      'importedCount': 'Imported {count} transactions',
      'failedCount': '{count} failed',
      'pleaseSelectWalletFirst': 'Please select a wallet first',
      'transactionImported': 'Transaction imported',
      'approvedButImportFailed': 'Approved but import failed',
      'merchantDescription': 'Merchant / Description',
      'countPendingTransactions': '{count} pending transactions',
    },
    'vi': {
      'appTitle': 'Bexly',
      'home': 'Trang chủ',
      ...
      'noPendingToReview': 'Không có giao dịch chờ duyệt',
      'bulkActions': 'Thao tác hàng loạt',
      'acceptAll': 'Chấp nhận tất cả',
      'rejectAll': 'Từ chối tất cả',
      'acceptAllConfirm': 'Chấp nhận tất cả?',
      'acceptAllDescription': 'Thao tác này sẽ import tất cả giao dịch chờ duyệt với danh mục được gợi ý. Giao dịch không có danh mục sẽ bị bỏ qua.',
      'rejectAllConfirm': 'Từ chối tất cả?',
      'rejectAllDescription': 'Thao tác này sẽ từ chối tất cả giao dịch chờ duyệt. Chúng sẽ không xuất hiện lại trong các lần quét sau.',
      'transactionsImportedCount': 'Đã import {count} giao dịch',
      'transactionsRejectedCount': 'Đã từ chối {count} giao dịch',
      'transactionRejected': 'Đã từ chối giao dịch',
      'pending': 'Chờ duyệt',
      'pendingTransactions': 'Giao dịch chờ duyệt',
      'reviewAndImport': 'Xem lại và import giao dịch',
      'approve': 'Chấp nhận',
      'reject': 'Từ chối',
      'reviewTransactions': 'Xem lại giao dịch',
      'approveAll': 'Chấp nhận tất cả',
      'noTransactionsToReview': 'Không có giao dịch cần xem lại',
      'scanEmailsDesc': 'Quét email để tìm giao dịch ngân hàng',
      'goBack': 'Quay lại',
      'pleaseSelectWallets': 'Vui lòng chọn ví',
      'transactionsNeedWallet': '{count} giao dịch cần chọn ví',
      'importedCount': 'Đã import {count} giao dịch',
      'failedCount': '{count} thất bại',
      'pleaseSelectWalletFirst': 'Vui lòng chọn ví trước',
      'transactionImported': 'Đã import giao dịch',
      'approvedButImportFailed': 'Đã duyệt nhưng import thất bại',
      'merchantDescription': 'Người bán / Mô tả',
      'countPendingTransactions': '{count} giao dịch chờ duyệt',
    },
    'zh': {
      'appTitle': 'Bexly',
      'home': '首页',
      ...
      // Pending transactions & bulk actions
      'allCaughtUp': '全部处理完毕！',
      'noPendingToReview': '没有待审核的交易',
      'bulkActions': '批量操作',
      'acceptAll': '全部接受',
      'rejectAll': '全部拒绝',
      'acceptAllConfirm': '全部接受？',
      'acceptAllDescription': '这将使用建议的分类导入所有待处理交易。没有分类的交易将被跳过。',
      'rejectAllConfirm': '全部拒绝？',
      'rejectAllDescription': '这将拒绝所有待处理交易。它们不会在未来的扫描中再次出现。',
      'transactionsImportedCount': '已导入 {count} 笔交易',
      'transactionsRejectedCount': '已拒绝 {count} 笔交易',
      'transactionRejected': '交易已拒绝',
      'pending': '待处理',
      'pendingTransactions': '待处理交易',
      'reviewAndImport': '审核并导入交易',
      'approve': '批准',
      'reject': '拒绝',
      'reviewTransactions': '审核交易',
      'approveAll': '全部批准',
      'noTransactionsToReview': '没有需要审核的交易',
      'scanEmailsDesc': '扫描邮件以查找银行交易',
      'goBack': '返回',
      'pleaseSelectWallets': '请选择钱包',
      'transactionsNeedWallet': '{count} 笔交易需要选择钱包',
      'importedCount': '已导入 {count} 笔交易',
      'failedCount': '{count} 笔失败',
      'pleaseSelectWalletFirst': '请先选择一个钱包',
      'transactionImported': '交易已导入',
      'approvedButImportFailed': '已批准但导入失败',
      'merchantDescription': '商户 / 描述',
      'countPendingTransactions': '{count} 笔待处理交易',
    },
    'fr': {
      'appTitle': 'Bexly',
      'home': 'Accueil',
      ...
      'noPendingToReview': 'Aucune transaction en attente',
      'bulkActions': 'Actions groupées',
      'acceptAll': 'Tout accepter',
      'rejectAll': 'Tout rejeter',
      'acceptAllConfirm': 'Tout accepter ?',
      'acceptAllDescription': 'Cela importera toutes les transactions en attente avec leurs catégories suggérées. Les transactions sans catégorie seront ignorées.',
      'rejectAllConfirm': 'Tout rejeter ?',
      'rejectAllDescription': 'Cela rejettera toutes les transactions en attente. Elles ne réapparaîtront pas lors des prochains scans.',
      'transactionsImportedCount': '{count} transactions importées',
      'transactionsRejectedCount': '{count} transactions rejetées',
      'transactionRejected': 'Transaction rejetée',
      'pending': 'En attente',
      'pendingTransactions': 'Transactions en attente',
      'reviewAndImport': 'Vérifier et importer les transactions',
      'approve': 'Approuver',
      'reject': 'Rejeter',
      'reviewTransactions': 'Vérifier les transactions',
      'approveAll': 'Tout approuver',
      'noTransactionsToReview': 'Aucune transaction à vérifier',
      'scanEmailsDesc': 'Scanner vos emails pour trouver des transactions bancaires',
      'goBack': 'Retour',
      'pleaseSelectWallets': 'Veuillez sélectionner des portefeuilles',
      'transactionsNeedWallet': '{count} transactions nécessitent un portefeuille',
      'importedCount': '{count} transactions importées',
      'failedCount': '{count} échouées',
      'pleaseSelectWalletFirst': 'Veuillez d\'abord sélectionner un portefeuille',
      'transactionImported': 'Transaction importée',
      'approvedButImportFailed': 'Approuvée mais import échoué',
      'merchantDescription': 'Marchand / Description',
      'countPendingTransactions': '{count} transactions en attente',
    },
    'th': {
      'appTitle': 'Bexly',
      'home': 'หน้าแรก',
      ...
      // Pending transactions & bulk actions
      'allCaughtUp': 'เรียบร้อยแล้ว!',
      'noPendingToReview': 'ไม่มีรายการรอตรวจสอบ',
      'bulkActions': 'ดำเนินการหลายรายการ',
      'acceptAll': 'ยอมรับทั้งหมด',
      'rejectAll': 'ปฏิเสธทั้งหมด',
      'acceptAllConfirm': 'ยอมรับทั้งหมด?',
      'acceptAllDescription': 'จะนำเข้ารายการรอดำเนินการทั้งหมดโดยใช้หมวดหมู่ที่แนะนำ รายการที่ไม่มีหมวดหมู่จะถูกข้าม',
      'rejectAllConfirm': 'ปฏิเสธทั้งหมด?',
      'rejectAllDescription': 'จะปฏิเสธรายการรอดำเนินการทั้งหมด จะไม่ปรากฏอีกในการสแกนครั้งต่อไป',
      'transactionsImportedCount': 'นำเข้า {count} รายการแล้ว',
      'transactionsRejectedCount': 'ปฏิเสธ {count} รายการแล้ว',
      'transactionRejected': 'ปฏิเสธรายการแล้ว',
      'pending': 'รอดำเนินการ',
      'pendingTransactions': 'รายการรอดำเนินการ',
      'reviewAndImport': 'ตรวจสอบและนำเข้ารายการ',
      'approve': 'อนุมัติ',
      'reject': 'ปฏิเสธ',
      'reviewTransactions': 'ตรวจสอบรายการ',
      'approveAll': 'อนุมัติทั้งหมด',
      'noTransactionsToReview': 'ไม่มีรายการต้องตรวจสอบ',
      'scanEmailsDesc': 'สแกนอีเมลเพื่อค้นหารายการธนาคาร',
      'goBack': 'ย้อนกลับ',
      'pleaseSelectWallets': 'กรุณาเลือกกระเป๋าเงิน',
      'transactionsNeedWallet': '{count} รายการต้องเลือกกระเป๋าเงิน',
      'importedCount': 'นำเข้า {count} รายการแล้ว',
      'failedCount': '{count} ล้มเหลว',
      'pleaseSelectWalletFirst': 'กรุณาเลือกกระเป๋าเงินก่อน',
      'transactionImported': 'นำเข้ารายการแล้ว',
      'approvedButImportFailed': 'อนุมัติแล้วแต่นำเข้าล้มเหลว',
      'merchantDescription': 'ร้านค้า / รายละเอียด',
      'countPendingTransactions': '{count} รายการรอดำเนินการ',
      // Dialog strings
    ...
    'id': {
      ...
      'noPendingToReview': 'Tidak ada transaksi yang menunggu',
      'bulkActions': 'Tindakan Massal',
      'acceptAll': 'Terima Semua',
      'rejectAll': 'Tolak Semua',
      'acceptAllConfirm': 'Terima Semua?',
      'acceptAllDescription': 'Ini akan mengimpor semua transaksi yang menunggu menggunakan kategori yang disarankan. Transaksi tanpa kategori akan dilewati.',
      'rejectAllConfirm': 'Tolak Semua?',
      'rejectAllDescription': 'Ini akan menolak semua transaksi yang menunggu. Mereka tidak akan muncul lagi di pemindaian berikutnya.',
      'transactionsImportedCount': '{count} transaksi diimpor',
      'transactionsRejectedCount': '{count} transaksi ditolak',
      'transactionRejected': 'Transaksi ditolak',
      'pending': 'Menunggu',
      'pendingTransactions': 'Transaksi Menunggu',
      'reviewAndImport': 'Tinjau dan impor transaksi',
      'approve': 'Setujui',
      'reject': 'Tolak',
      'reviewTransactions': 'Tinjau Transaksi',
      'approveAll': 'Setujui Semua',
      'noTransactionsToReview': 'Tidak ada transaksi untuk ditinjau',
      'scanEmailsDesc': 'Pindai email Anda untuk menemukan transaksi bank',
      'goBack': 'Kembali',
      'pleaseSelectWallets': 'Silakan pilih dompet',
      'transactionsNeedWallet': '{count} transaksi perlu memilih dompet',
      'importedCount': '{count} transaksi diimpor',
      'failedCount': '{count} gagal',
      'pleaseSelectWalletFirst': 'Silakan pilih dompet terlebih dahulu',
      'transactionImported': 'Transaksi diimpor',
      'approvedButImportFailed': 'Disetujui tapi impor gagal',
      'merchantDescription': 'Merchant / Deskripsi',
      'countPendingTransactions': '{count} transaksi menunggu',
      // Dialog strings
    ...
    'es': {
      ...
      'noPendingToReview': 'No hay transacciones pendientes',
      'bulkActions': 'Acciones masivas',
      'acceptAll': 'Aceptar todo',
      'rejectAll': 'Rechazar todo',
      'acceptAllConfirm': '¿Aceptar todo?',
      'acceptAllDescription': 'Esto importará todas las transacciones pendientes usando sus categorías sugeridas. Las transacciones sin categoría serán omitidas.',
      'rejectAllConfirm': '¿Rechazar todo?',
      'rejectAllDescription': 'Esto rechazará todas las transacciones pendientes. No volverán a aparecer en futuros escaneos.',
      'transactionsImportedCount': '{count} transacciones importadas',
      'transactionsRejectedCount': '{count} transacciones rechazadas',
      'transactionRejected': 'Transacción rechazada',
      'pending': 'Pendiente',
      'pendingTransactions': 'Transacciones pendientes',
      'reviewAndImport': 'Revisar e importar transacciones',
      'approve': 'Aprobar',
      'reject': 'Rechazar',
      'reviewTransactions': 'Revisar transacciones',
      'approveAll': 'Aprobar todo',
      'noTransactionsToReview': 'No hay transacciones para revisar',
      'scanEmailsDesc': 'Escanea tus correos para encontrar transacciones bancarias',
      'goBack': 'Volver',
      'pleaseSelectWallets': 'Por favor seleccione billeteras',
      'transactionsNeedWallet': '{count} transacciones necesitan una billetera',
      'importedCount': '{count} transacciones importadas',
      'failedCount': '{count} fallidas',
      'pleaseSelectWalletFirst': 'Por favor seleccione una billetera primero',
      'transactionImported': 'Transacción importada',
      'approvedButImportFailed': 'Aprobada pero la importación falló',
      'merchantDescription': 'Comerciante / Descripción',
      'countPendingTransactions': '{count} transacciones pendientes',
      // Dialog strings
    ...
    'pt': {
      ...
      'noPendingToReview': 'Nenhuma transação pendente',
      'bulkActions': 'Ações em massa',
      'acceptAll': 'Aceitar tudo',
      'rejectAll': 'Rejeitar tudo',
      'acceptAllConfirm': 'Aceitar tudo?',
      'acceptAllDescription': 'Isso importará todas as transações pendentes usando suas categorias sugeridas. Transações sem categoria serão ignoradas.',
      'rejectAllConfirm': 'Rejeitar tudo?',
      'rejectAllDescription': 'Isso rejeitará todas as transações pendentes. Elas não reaparecerão em futuras varreduras.',
      'transactionsImportedCount': '{count} transações importadas',
      'transactionsRejectedCount': '{count} transações rejeitadas',
      'transactionRejected': 'Transação rejeitada',
      'pending': 'Pendente',
      'pendingTransactions': 'Transações pendentes',
      'reviewAndImport': 'Revisar e importar transações',
      'approve': 'Aprovar',
      'reject': 'Rejeitar',
      'reviewTransactions': 'Revisar transações',
      'approveAll': 'Aprovar tudo',
      'noTransactionsToReview': 'Nenhuma transação para revisar',
      'scanEmailsDesc': 'Escaneie seus e-mails para encontrar transações bancárias',
      'goBack': 'Voltar',
      'pleaseSelectWallets': 'Por favor selecione carteiras',
      'transactionsNeedWallet': '{count} transações precisam de uma carteira',
      'importedCount': '{count} transações importadas',
      'failedCount': '{count} falharam',
      'pleaseSelectWalletFirst': 'Por favor selecione uma carteira primeiro',
      'transactionImported': 'Transação importada',
      'approvedButImportFailed': 'Aprovada mas a importação falhou',
      'merchantDescription': 'Comerciante / Descrição',
      'countPendingTransactions': '{count} transações pendentes',
      // Dialog strings
    ...
    'ja': {
      ...
      // Pending transactions & bulk actions
      'allCaughtUp': 'すべて処理済み！',
      'noPendingToReview': '確認待ちの取引はありません',
      'bulkActions': '一括操作',
      'acceptAll': 'すべて承認',
      'rejectAll': 'すべて拒否',
      'acceptAllConfirm': 'すべて承認しますか？',
      'acceptAllDescription': '提案されたカテゴリを使用して、保留中のすべての取引をインポートします。カテゴリのない取引はスキップされます。',
      'rejectAllConfirm': 'すべて拒否しますか？',
      'rejectAllDescription': '保留中のすべての取引を拒否します。今後のスキャンで再表示されません。',
      'transactionsImportedCount': '{count}件の取引をインポートしました',
      'transactionsRejectedCount': '{count}件の取引を拒否しました',
      'transactionRejected': '取引を拒否しました',
      'pending': '保留中',
      'pendingTransactions': '保留中の取引',
      'reviewAndImport': '取引を確認してインポート',
      'approve': '承認',
      'reject': '拒否',
      'reviewTransactions': '取引を確認',
      'approveAll': 'すべて承認',
      'noTransactionsToReview': '確認する取引はありません',
      'scanEmailsDesc': 'メールをスキャンして銀行取引を検索',
      'goBack': '戻る',
      'pleaseSelectWallets': 'ウォレットを選択してください',
      'transactionsNeedWallet': '{count}件の取引にウォレットの選択が必要です',
      'importedCount': '{count}件の取引をインポートしました',
      'failedCount': '{count}件失敗',
      'pleaseSelectWalletFirst': '先にウォレットを選択してください',
      'transactionImported': '取引をインポートしました',
      'approvedButImportFailed': '承認済みですがインポートに失敗しました',
      'merchantDescription': '加盟店 / 説明',
      'countPendingTransactions': '{count}件の保留中の取引',
      // Dialog strings
      'deleteBudget': '予算を削除',
    ...
    'ko': {
      ...
      // Pending transactions & bulk actions
      'allCaughtUp': '모두 처리 완료!',
      'noPendingToReview': '검토할 대기 거래가 없습니다',
      'bulkActions': '일괄 작업',
      'acceptAll': '모두 수락',
      'rejectAll': '모두 거부',
      'acceptAllConfirm': '모두 수락하시겠습니까?',
      'acceptAllDescription': '제안된 카테고리를 사용하여 모든 대기 거래를 가져옵니다. 카테고리가 없는 거래는 건너뜁니다.',
      'rejectAllConfirm': '모두 거부하시겠습니까?',
      'rejectAllDescription': '모든 대기 거래를 거부합니다. 향후 스캔에서 다시 표시되지 않습니다.',
      'transactionsImportedCount': '{count}건의 거래를 가져왔습니다',
      'transactionsRejectedCount': '{count}건의 거래를 거부했습니다',
      'transactionRejected': '거래가 거부되었습니다',
      'pending': '대기 중',
      'pendingTransactions': '대기 중인 거래',
      'reviewAndImport': '거래 검토 및 가져오기',
      'approve': '승인',
      'reject': '거부',
      'reviewTransactions': '거래 검토',
      'approveAll': '모두 승인',
      'noTransactionsToReview': '검토할 거래가 없습니다',
      'scanEmailsDesc': '이메일을 스캔하여 은행 거래를 찾습니다',
      'goBack': '뒤로',
      'pleaseSelectWallets': '지갑을 선택해주세요',
      'transactionsNeedWallet': '{count}건의 거래에 지갑 선택이 필요합니다',
      'importedCount': '{count}건의 거래를 가져왔습니다',
      'failedCount': '{count}건 실패',
      'pleaseSelectWalletFirst': '먼저 지갑을 선택해주세요',
      'transactionImported': '거래를 가져왔습니다',
      'approvedButImportFailed': '승인되었으나 가져오기 실패',
      'merchantDescription': '가맹점 / 설명',
      'countPendingTransactions': '{count}건의 대기 거래',
      // Dialog strings
      'deleteBudget': '예산 삭제',
    ...
    'de': {
      ...
      'noPendingToReview': 'Keine ausstehenden Transaktionen',
      'bulkActions': 'Massenaktionen',
      'acceptAll': 'Alle akzeptieren',
      'rejectAll': 'Alle ablehnen',
      'acceptAllConfirm': 'Alle akzeptieren?',
      'acceptAllDescription': 'Dies importiert alle ausstehenden Transaktionen mit den vorgeschlagenen Kategorien. Transaktionen ohne Kategorie werden übersprungen.',
      'rejectAllConfirm': 'Alle ablehnen?',
      'rejectAllDescription': 'Dies lehnt alle ausstehenden Transaktionen ab. Sie werden bei zukünftigen Scans nicht wieder erscheinen.',
      'transactionsImportedCount': '{count} Transaktionen importiert',
      'transactionsRejectedCount': '{count} Transaktionen abgelehnt',
      'transactionRejected': 'Transaktion abgelehnt',
      'pending': 'Ausstehend',
      'pendingTransactions': 'Ausstehende Transaktionen',
      'reviewAndImport': 'Transaktionen prüfen und importieren',
      'approve': 'Genehmigen',
      'reject': 'Ablehnen',
      'reviewTransactions': 'Transaktionen prüfen',
      'approveAll': 'Alle genehmigen',
      'noTransactionsToReview': 'Keine Transaktionen zu prüfen',
      'scanEmailsDesc': 'E-Mails nach Banktransaktionen durchsuchen',
      'goBack': 'Zurück',
      'pleaseSelectWallets': 'Bitte Geldbörsen auswählen',
      'transactionsNeedWallet': '{count} Transaktionen benötigen eine Geldbörse',
      'importedCount': '{count} Transaktionen importiert',
      'failedCount': '{count} fehlgeschlagen',
      'pleaseSelectWalletFirst': 'Bitte wählen Sie zuerst eine Geldbörse',
      'transactionImported': 'Transaktion importiert',
      'approvedButImportFailed': 'Genehmigt aber Import fehlgeschlagen',
      'merchantDescription': 'Händler / Beschreibung',
      'countPendingTransactions': '{count} ausstehende Transaktionen',
      // Dialog strings
    ...
    'hi': {
      ...
      'noPendingToReview': 'कोई लंबित लेनदेन नहीं',
      'bulkActions': 'सामूहिक कार्रवाई',
      'acceptAll': 'सभी स्वीकार करें',
      'rejectAll': 'सभी अस्वीकार करें',
      'acceptAllConfirm': 'सभी स्वीकार करें?',
      'acceptAllDescription': 'यह सुझाई गई श्रेणियों का उपयोग करके सभी लंबित लेनदेन आयात करेगा। बिना श्रेणी वाले लेनदेन छोड़ दिए जाएंगे।',
      'rejectAllConfirm': 'सभी अस्वीकार करें?',
      'rejectAllDescription': 'यह सभी लंबित लेनदेन अस्वीकार कर देगा। वे भविष्य के स्कैन में दिखाई नहीं देंगे।',
      'transactionsImportedCount': '{count} लेनदेन आयात किए गए',
      'transactionsRejectedCount': '{count} लेनदेन अस्वीकार किए गए',
      'transactionRejected': 'लेनदेन अस्वीकार किया गया',
      'pending': 'लंबित',
      'pendingTransactions': 'लंबित लेनदेन',
      'reviewAndImport': 'लेनदेन समीक्षा और आयात करें',
      'approve': 'स्वीकृत',
      'reject': 'अस्वीकृत',
      'reviewTransactions': 'लेनदेन समीक्षा करें',
      'approveAll': 'सभी स्वीकृत करें',
      'noTransactionsToReview': 'समीक्षा के लिए कोई लेनदेन नहीं',
      'scanEmailsDesc': 'बैंक लेनदेन खोजने के लिए ईमेल स्कैन करें',
      'goBack': 'वापस जाएं',
      'pleaseSelectWallets': 'कृपया वॉलेट चुनें',
      'transactionsNeedWallet': '{count} लेनदेन को वॉलेट चुनने की आवश्यकता है',
      'importedCount': '{count} लेनदेन आयात किए गए',
      'failedCount': '{count} विफल',
      'pleaseSelectWalletFirst': 'कृपया पहले एक वॉलेट चुनें',
      'transactionImported': 'लेनदेन आयात किया गया',
      'approvedButImportFailed': 'स्वीकृत लेकिन आयात विफल',
      'merchantDescription': 'व्यापारी / विवरण',
      'countPendingTransactions': '{count} लंबित लेनदेन',
      // Dialog strings
    ...
    'ru': {
      ...
      'noPendingToReview': 'Нет ожидающих транзакций',
      'bulkActions': 'Массовые действия',
      'acceptAll': 'Принять все',
      'rejectAll': 'Отклонить все',
      'acceptAllConfirm': 'Принять все?',
      'acceptAllDescription': 'Это импортирует все ожидающие транзакции с предложенными категориями. Транзакции без категории будут пропущены.',
      'rejectAllConfirm': 'Отклонить все?',
      'rejectAllDescription': 'Это отклонит все ожидающие транзакции. Они не появятся при следующих сканированиях.',
      'transactionsImportedCount': '{count} транзакций импортировано',
      'transactionsRejectedCount': '{count} транзакций отклонено',
      'transactionRejected': 'Транзакция отклонена',
      'pending': 'Ожидание',
      'pendingTransactions': 'Ожидающие транзакции',
      'reviewAndImport': 'Проверить и импортировать транзакции',
      'approve': 'Одобрить',
      'reject': 'Отклонить',
      'reviewTransactions': 'Проверить транзакции',
      'approveAll': 'Одобрить все',
      'noTransactionsToReview': 'Нет транзакций для проверки',
      'scanEmailsDesc': 'Сканировать почту для поиска банковских транзакций',
      'goBack': 'Назад',
      'pleaseSelectWallets': 'Пожалуйста, выберите кошельки',
      'transactionsNeedWallet': '{count} транзакций нуждаются в выборе кошелька',
      'importedCount': 'Импортировано {count} транзакций',
      'failedCount': '{count} неудачных',
      'pleaseSelectWalletFirst': 'Сначала выберите кошелёк',
      'transactionImported': 'Транзакция импортирована',
      'approvedButImportFailed': 'Одобрено, но импорт не удался',
      'merchantDescription': 'Продавец / Описание',
      'countPendingTransactions': '{count} ожидающих транзакций',
      // Default wallet
    ...
    'ar': {
      ...
      // Pending transactions & bulk actions
      'allCaughtUp': 'تم معالجة الكل!',
      'noPendingToReview': 'لا توجد معاملات معلقة',
      'bulkActions': 'إجراءات جماعية',
      'acceptAll': 'قبول الكل',
      'rejectAll': 'رفض الكل',
      'acceptAllConfirm': 'قبول الكل؟',
      'acceptAllDescription': 'سيتم استيراد جميع المعاملات المعلقة باستخدام الفئات المقترحة. سيتم تخطي المعاملات بدون فئة.',
      'rejectAllConfirm': 'رفض الكل؟',
      'rejectAllDescription': 'سيتم رفض جميع المعاملات المعلقة. لن تظهر مرة أخرى في عمليات المسح المستقبلية.',
      'transactionsImportedCount': 'تم استيراد {count} معاملة',
      'transactionsRejectedCount': 'تم رفض {count} معاملة',
      'transactionRejected': 'تم رفض المعاملة',
      'pending': 'معلق',
      'pendingTransactions': 'المعاملات المعلقة',
      'reviewAndImport': 'مراجعة واستيراد المعاملات',
      'approve': 'موافقة',
      'reject': 'رفض',
      'reviewTransactions': 'مراجعة المعاملات',
      'approveAll': 'الموافقة على الكل',
      'noTransactionsToReview': 'لا توجد معاملات للمراجعة',
      'scanEmailsDesc': 'مسح البريد الإلكتروني للعثور على المعاملات المصرفية',
      'goBack': 'رجوع',
      'pleaseSelectWallets': 'يرجى اختيار المحافظ',
      'transactionsNeedWallet': '{count} معاملة تحتاج إلى اختيار محفظة',
      'importedCount': 'تم استيراد {count} معاملة',
      'failedCount': '{count} فشلت',
      'pleaseSelectWalletFirst': 'يرجى اختيار محفظة أولاً',
      'transactionImported': 'تم استيراد المعاملة',
      'approvedButImportFailed': 'تمت الموافقة لكن الاستيراد فشل',
      'merchantDescription': 'التاجر / الوصف',
      'countPendingTransactions': '{count} معاملة معلقة',
      // Dialog strings
  ...
  String get numberFormat => get('numberFormat');
  ...
  // Pending transactions & bulk actions
  String get allCaughtUp => get('allCaughtUp');
  String get noPendingToReview => get('noPendingToReview');
  String get bulkActions => get('bulkActions');
  String get acceptAll => get('acceptAll');
  String get rejectAll => get('rejectAll');
  String get acceptAllConfirm => get('acceptAllConfirm');
  String get acceptAllDescription => get('acceptAllDescription');
  String get rejectAllConfirm => get('rejectAllConfirm');
  String get rejectAllDescription => get('rejectAllDescription');
  String transactionsImportedCount(int count) => get('transactionsImportedCount').replaceAll('{count}', count.toString());
  String transactionsRejectedCount(int count) => get('transactionsRejectedCount').replaceAll('{count}', count.toString());
  String get transactionRejected => get('transactionRejected');
  String get pending => get('pending');
  String get pendingTransactions => get('pendingTransactions');
  String get reviewAndImport => get('reviewAndImport');
  String get approve => get('approve');
  String get reject => get('reject');
  String get reviewTransactions => get('reviewTransactions');
  String get approveAll => get('approveAll');
  String get noTransactionsToReview => get('noTransactionsToReview');
  String get scanEmailsDesc => get('scanEmailsDesc');
  String get goBack => get('goBack');
  String get pleaseSelectWallets => get('pleaseSelectWallets');
  String transactionsNeedWallet(int count) => get('transactionsNeedWallet').replaceAll('{count}', count.toString());
  String importedCount(int count) => get('importedCount').replaceAll('{count}', count.toString());
  String failedCount(int count) => get('failedCount').replaceAll('{count}', count.toString());
  String get pleaseSelectWalletFirst => get('pleaseSelectWalletFirst');
  String get transactionImported => get('transactionImported');
  String get approvedButImportFailed => get('approvedButImportFailed');
  String get merchantDescription => get('merchantDescription');
  String countPendingTransactions(int count) => get('countPendingTransactions').replaceAll('{count}', count.toString());
  // Dialog strings
